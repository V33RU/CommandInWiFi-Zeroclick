...
void loop() {
  // Check if 2 minutes have passed for SSID change
  ...
  // Check if 1 minute has passed to list devices
...
void listConnectedDevices() {
  ...
  wifi_softap_free_station_info(); // Free it by calling function
}
